...
def ScoreCam(model, img_array, layer_name, max_N=-1):
    ...
    act_map_resized_list = [cv2.resize(act_map_array[0,:,k],(input_shape[0],1), interpolation=cv2.INTER_LINEAR) for k in range(act_map_array.shape[2])]
    ...
    for act_map_normalized in act_map_normalized_list:
        ...
        for k in range(1):
            masked_input[0,:,k] == masked_input[0,:,k]*act_map_normalized
